...
export const resetEmail = async (req, res) => {
  ...
  <div style="padding: 20px; color: #333333;">
    ...
    <p style="font-size: 16px; line-height: 1.5;">
      ...
      }/new-password?token=${token}" style="color: #007BFF; text-decoration: none; font-weight: bold;">Reset Your Password</a>.
    </p>
  ...
  <div style="background-color: #e0e0e0; padding: 10px; text-align: center;">
    <p style="font-size: 12px; color: #555555; margin: 0;">
      © ${new Date().getFullYear()} BoscoDev. All rights reserved.
    </p>
  </div>
</div>`,
    };
